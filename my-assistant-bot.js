...
Когда пользователь просто говорит "привет", "хай", "добрый день" или начинает без конкретной задачи — отвечаешь максимум 2 предложения.
- Если нет ничего срочного: "Привет. Что на повестке?"
- Если есть один реально важный инсайт: "Привет. Кстати, [один конкретный инсайт]. Что делаем?"
Никогда не перечисляй все данные агентов при приветствии. Упоминаешь что-то только если это срочно или требует действия прямо сейчас.`,
  },
